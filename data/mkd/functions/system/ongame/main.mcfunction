...
## Detect police drop
execute as @a[team=Police,scores={Death=1..}] at @s run function mkd:system/ongame/police_drop

## Detect robber drop
execute as @a[team=Robber,scores={Death=1..}] at @s run function mkd:system/ongame/robber_drop
...
tag @a[team=Police] remove SetRespawn
...
tag @a[team=Robber] remove SetRespawn
