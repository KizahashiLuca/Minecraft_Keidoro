...
## Give Effect
effect give @a[team=Police] minecraft:blindness 1000000 100 true
effect give @a[team=Police] minecraft:slowness 1000000 100 true
effect give @a[gamemode=!spectator] minecraft:resistance 1000000 100 true
