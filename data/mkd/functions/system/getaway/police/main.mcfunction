...
give @a[team=Police] minecraft:tipped_arrow{display:{Name:"\"\\u00A7r\\u00A7bスタングレネード\"",Lore:["\"\\u00A7r\\u00A7c移動速度低下 Ⅶ (0:10)\"","\"\\u00A7r\\u00A7c盲目 (0:10)\"","\"\"","\"\\u00A7r\\u00A75効果:\"","\"\\u00A7r\\u00A7c移動速度上昇 -120%\""]},CustomPotionEffects:[{Id:2,Amplifier:7,Duration:200},{Id:15,Duration:200}],HideFlags:32} 10